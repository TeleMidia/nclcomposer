...
QVector<StructuralEntity*> StructuralScene::getRoots() const
{
  return roots;
}

void StructuralScene::addRoot(StructuralEntity* entity)
{
  if (entity != NULL)
  {
    roots.append(entity);
...
void StructuralScene::removeRoot(StructuralEntity* entity)
{
  if (entity != NULL)
  {
...
void StructuralScene::performAdd(QnstSubtype subtype)
{

...
StructuralGraphicsProperty::StructuralGraphicsProperty(StructuralGraphicsEntity* parent)
  : StructuralGraphicsInterface(parent)
{
  setnstType(Structural::Property);
}

StructuralGraphicsProperty::~StructuralGraphicsProperty()
{

}

void StructuralGraphicsProperty::draw(QPainter* painter)
{
  QColor bg;
  QColor border;
...
void StructuralGraphicsProperty::delineate(QPainterPath* painter) const
{

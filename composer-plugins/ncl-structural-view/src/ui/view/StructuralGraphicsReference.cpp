...
StructuralGraphicsReference::StructuralGraphicsReference(StructuralGraphicsEntity* parent)
  : StructuralGraphicsEdge(parent)
{
  setnstType(Structural::Reference);
}

StructuralGraphicsReference::~StructuralGraphicsReference()
{

}

void StructuralGraphicsReference::draw(QPainter* painter)
{
...
void StructuralGraphicsReference::delineate(QPainterPath* painter) const
{
  if (getEntityA() != NULL && getEntityB() != NULL)
  {
    QLineF line = QLineF(QPointF(getEntityA()->getLeft() + getEntityA()->getWidth()/2,

...
void Node::createMenus()
{
    ...
    // spread menu
    spreadMenu = new QMenu();
    spreadMenu->setTitle(tr("Spread"));

    spreadMenu->addAction(clockAction);
    spreadMenu->addSeparator();
    spreadMenu->addAction(attractAction);
    spreadMenu->addAction(repelAction);

    spreadMenu->setEnabled(true);
    ...
    contextMenu->addMenu(spreadMenu);

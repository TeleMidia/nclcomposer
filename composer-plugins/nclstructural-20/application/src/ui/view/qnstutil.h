...
public:
   ...
   */
  static QnstEntity *makeGraphicsEntity(Qnst::EntitySubtype type,
                                                QnstEntity *parent = 0,
   ...
   */
  static Qnst::EntitySubtype getnstTypeFromMime(const QString &mimeType);
   ...
   */
  static QString iconFromMediaType(Qnst::EntitySubtype type);
   ...
   */
  static Qnst::EntitySubtype getnstTypeFromExtension(const QString &ext);
   ...
   */
  static Qnst::EntitySubtype getnstTypeFromStr(const QString &strType);
   ...
   */
  static QString getStrFromNstType(Qnst::EntitySubtype type);
   ...
   */
  static QString getPrefixIdFromType(Qnst::EntitySubtype type);
...
private:
  static std::map <Qnst::EntitySubtype, QString>   iconFromTypeMap;
  static std::map <QString, Qnst::EntitySubtype>   typeFromExtMap;
  static std::map <QString, Qnst::EntitySubtype>   typeFromStr;
  static std::map <Qnst::EntitySubtype, QString>   strFromType;
  static std::map  <Qnst::EntitySubtype, QString>  prefixIdFromType;

...
class Region : public QObject, public QGraphicsItem
{
    Q_OBJECT
    Q_INTERFACES(QGraphicsItem)

public:
    explicit Region(QMenu* switchMenu, Region* parent = 0);
    virtual ~Region();
...
signals:
    void regionAdditionRequested(Region* parent);
    void regionSelectionRequested(Region* region);
    void regionDeletionRequested(Region* region);
    void regionChangeRequested(Region* region,
                               QMap<QString, QString> attributes);
    void dragMediaOverRegion(QString mediaid, Region *region);

...
void LayoutItem::addItem(QGraphicsItem* item)
{
    //TODO: LayoutItem::addItem(...)
}
                   ...
                   QWidget *widget)
{
    ...
    painter->drawText(QRectF(10,10,
                             size.width()*0.6,size.height()*0.6),title);
...
void LayoutItem::unselect(LayoutItem *parent)
{
    setSelected(false);
    ...
    if (parent != 0){
        ...
        for (int i=0;i<childItems().size();i++){
            LayoutItem* item = (LayoutItem*) childItems().at(i);

...
bool
LanguageControl::removeProfile (LanguageType type)
{
...
ILanguageProfile *
LanguageControl::loadProfile (const QString &fileName)
{
...
void
LanguageControl::loadProfiles (const QString &profilesDirPath)
{

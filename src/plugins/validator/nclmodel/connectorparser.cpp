...
bool
ConnectorParser::startElement (const QString &, const QString &,
                               const QString &qName,
                               const QXmlAttributes &atts)
{
  ...
  if (id == _connectorId
      && strcmp (qName.toStdString ().c_str (), "causalConnector") == 0)
  {
    flag = true;
  }
...
bool
ConnectorParser::endElement (const QString &namespaceURI,

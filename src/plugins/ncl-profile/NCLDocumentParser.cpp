...
bool
NCLDocumentParser::parseContent (const QString &str)
{
...
bool
NCLDocumentParser::startElement (const QString &, const QString &,
                                 const QString &qName,
...
bool
NCLDocumentParser::endElement (const QString &namespaceURI,
...
bool
NCLDocumentParser::characters (const QString &)
{
  return true;
}

bool
NCLDocumentParser::endDocument ()
{
  emit parseFinished ();
  return true;
}
...
bool
NCLDocumentParser::fatalError (const QXmlParseException &exception)
{
  qDebug () << "Fatal error on line" << exception.lineNumber () << ", column"
...
void
NCLDocumentParser::onEntityAdded (const QString &, Entity *entity)
{
  _lockStack.lock ();
...
void
NCLDocumentParser::onEntityAddError (const QString &error)
{

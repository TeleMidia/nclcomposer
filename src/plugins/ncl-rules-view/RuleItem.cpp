...
RuleItem::RuleItem (QTreeWidgetItem *item, const QString &id,
                    const QString &var, const QString &comparator,
                    const QString &value, const int &type, QWidget *parent)
...
void
RuleItem::init (const QString &id, const QString &var,
                const QString &comparator, const QString &value)
{

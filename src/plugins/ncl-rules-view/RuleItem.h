...
public:
  ...
  explicit RuleItem (QTreeWidgetItem *item, const QString &id,
                     const QString &var, const QString &comparator,
                     const QString &value, const int &type,
                     QWidget *parent = 0);
  ...
  inline void
  setVar (const QString &var)
  {
    changeComboValue (_varCombo, var);
  }

  inline void
  setComparator (const QString &comparator)
  {
  ...
  inline void
  changeComboValue (QComboBox *combo, const QString &value)
  {

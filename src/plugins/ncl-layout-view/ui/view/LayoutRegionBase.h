...
public:
  ...
  void addRegion (LayoutRegion *_region, LayoutRegion *parent,
...
protected:
  ...
  void createSafeArea ();
  /*!
   * \brief getSafeAreaRect returns a rect related that represents the safe
   * area
...
protected slots:
  ...
  void requestRegionChange (LayoutRegion *_region,
                            QMap<QString, QString> attributes);
  void requestMediaOverRegionAction (QString mediaId, LayoutRegion *_region);

...
public slots:
  ...
  void addDescriptor (const QString regionUID, const QString descriptor);
  ...
  void requestRegionAddition (const QString regionUID, const QString parentUID,
                              const QString regionbaseUID,
...
signals:
  void regionAdded (const QString regionUID, const QString parentUID,
                    const QString regionbaseUID,
                    const QMap<QString, QString> attributes);

  void regionRemoved (const QString regionUID, const QString regionbaseUID);

  void regionSelected (const QString regionUID, const QString regionbaseUID);

  void regionChanged (const QString &regionUID, const QString &regionbaseUID,
                      const QMap<QString, QString> &attributes);
...
protected slots:
  void addRegion (LayoutRegion *region, LayoutRegion *parent,
                  LayoutRegionBase *regionBase,
                  const QMap<QString, QString> attributes);

  void removeRegion (LayoutRegion *region, LayoutRegionBase *regionBase);

  void changeRegion (LayoutRegion *region, LayoutRegionBase *regionBase,
                     const QMap<QString, QString> attributes);

  void selectRegion (LayoutRegion *region, LayoutRegionBase *regionBase);

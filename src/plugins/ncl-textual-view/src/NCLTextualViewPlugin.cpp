...
void NCLTextualViewPlugin::onEntityAdded(const QString &pluginID,
                                         Entity *entity)
{
...
void NCLTextualViewPlugin::onEntityRemoved(const QString &pluginID,
  ...
  while(!nodes.empty())
  {
        ...
        i++, j++)
    {
            ...
            && sameNCLID)
      {
        ...
        QMap <QString, QString> elementAttrs = entityChildren[j]->getAttributes();
        bool changed = false;

...
QsciLexerNCL::QsciLexerNCL (QObject *parent)
    : QsciLexerHTML (parent), _scripts (true)
{
}
...
QColor
QsciLexerNCL::defaultColor (int style) const
{
...
bool
QsciLexerNCL::defaultEolFill (int style) const
{
  if (style == CDATA)
    return true;
...
const char *
QsciLexerNCL::keywords (int set) const
{
  if (set == 6)
...
QColor
QsciLexerNCL::defaultPaper (int style) const
{
...
void
QsciLexerNCL::refreshProperties ()
{
  setScriptsProp ();
...
bool
QsciLexerNCL::readProperties (QSettings &qs, const QString &prefix)
{
...
bool
QsciLexerNCL::writeProperties (QSettings &qs, const QString &prefix) const
{
...
void
QsciLexerNCL::setScriptsStyled (bool styled)
{
  _scripts = styled;
  setScriptsProp ();
}

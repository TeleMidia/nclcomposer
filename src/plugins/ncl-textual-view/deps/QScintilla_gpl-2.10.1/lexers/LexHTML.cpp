...
static void ColouriseNCLDoc(Sci_PositionU startPos, Sci_Position length, int initStyle, WordList *keywordlists[],
                            Accessor &styler) {
...
LexerModule lmNCL(SCLEX_NCL, ColouriseNCLDoc, "ncl", 0, htmlWordListDesc);

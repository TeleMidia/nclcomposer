...
public:
  ...
  void addConditionInterface (const QString &uid, const QString &name,
                              const QString &icon);
  ...
  void addActionInterface (const QString &uid, const QString &name,
                           const QString &icon);
  void removeActionInterface (const QString &name);

  void setMode (const QString &connector = "", const QString &condition = "",
                const QString &action = "", Mode mode = CreateLink);
...
private:
  ...
  void addInterface (QComboBox *widget, const QString &uid,

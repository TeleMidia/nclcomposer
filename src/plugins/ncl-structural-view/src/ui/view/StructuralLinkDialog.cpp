    ...
    : QLineEdit (parent), _words (words)
{
  ...
  connect (_listView, SIGNAL (pressed (const QModelIndex &)), this,
           SLOT (completeText (const QModelIndex &)));
}

void
CompleteLineEdit::setStringList (const QStringList &words)
{
  this->_words = words;
  setCompleter (text ());
}
...
bool
CompleteLineEdit::eventFilter (QObject *object, QEvent *event)
{
...
void
CompleteLineEdit::updateListPos ()
{
  QPoint p (0, height ());
...
void
CompleteLineEdit::updateListSize ()
{
...
void
CompleteLineEdit::focusOutEvent (QFocusEvent *e)
{
...
void
CompleteLineEdit::focusInEvent (QFocusEvent *e)
{
...
void
CompleteLineEdit::updateCompleter (const QString &text)
{
  setCompleter (text);
  _listView->show ();
}
...
void
CompleteLineEdit::setCompleter (const QString &text)
{
...
void
CompleteLineEdit::completeText (const QModelIndex &index)
{
    ...
    : QDialog (parent), _aligned (false)
{
  ...
  _form.lyLink->addWidget (
      (_search = new CompleteLineEdit (QStringList (), this)), 0, 1);

  _mode = CreateLink;

  connect (_search, SIGNAL (textChanged (QString)),
           SLOT (changeContent (QString)));

  connect (_form.kbLinkParams, SIGNAL (stateChanged (int)), this,
           SLOT (switchConnectorParam (int)));
  connect (_form.kbConditionParams, SIGNAL (stateChanged (int)), this,
           SLOT (switchConditionParam (int)));
  connect (_form.kbActionParams, SIGNAL (stateChanged (int)), this,
           SLOT (switchActionParam (int)));
...
QString
StructuralLinkDialog::getConnector ()
{
  return _search->text ();
}

void
StructuralLinkDialog::setConnector (const QString &connector)
{
  _search->setText (connector);
}

QMap<QString, QString>
StructuralLinkDialog::getConnectorParams ()
{
  return getParams (_form.tbLinkParams);
}

void
StructuralLinkDialog::setConnectorParams (const QMap<QString, QString> &params)
{
  setParams (_form.tbLinkParams, params);
}

QString
StructuralLinkDialog::getCondition ()
{
  return _form.cbCondition->currentText ();
}

void
StructuralLinkDialog::setCondition (const QString &condition)
{
  _form.cbCondition->setCurrentText (condition);
}

QMap<QString, QString>
StructuralLinkDialog::getConditionParams ()
{
  return getParams (_form.tbConditionParams);
}

void
StructuralLinkDialog::setConditionParams (const QMap<QString, QString> &params)
{
  setParams (_form.tbConditionParams, params);
}

QString
StructuralLinkDialog::getConditionInterface ()
{
  return getInterface (_form.cbConditionInterface);
}

void
StructuralLinkDialog::setConditionInterface (const QString &name)
{
  setInterface (_form.cbConditionInterface, name);
}

QMap<QString, QString>
StructuralLinkDialog::getConditonInterfaces ()
{
  return getInterfaces (_form.cbConditionInterface);
}

void
StructuralLinkDialog::addConditionInterface (const QString &uid,
                                             const QString &name,
                                             const QString &icon)
{
...
void
StructuralLinkDialog::removeConditionInterface (const QString &name)
{
  removeInterface (_form.cbConditionInterface, name);
}

QString
StructuralLinkDialog::getAction ()
{
  return _form.cbAction->currentText ();
}

void
StructuralLinkDialog::setAction (const QString &action)
{
  _form.cbAction->setCurrentText (action);
}

QMap<QString, QString>
StructuralLinkDialog::getActionParams ()
{
  return getParams (_form.tbActionParams);
}

void
StructuralLinkDialog::setActionParams (const QMap<QString, QString> &params)
{
  setParams (_form.tbActionParams, params);
}

QString
StructuralLinkDialog::getActionInterface ()
{
  return getInterface (_form.cbActionInterface);
}

void
StructuralLinkDialog::setActionInterface (const QString &name)
{
  setInterface (_form.cbActionInterface, name);
}

QMap<QString, QString>
StructuralLinkDialog::getActionInterfaces ()
{
  return getInterfaces (_form.cbActionInterface);
}

void
StructuralLinkDialog::addActionInterface (const QString &uid,
                                          const QString &name,
                                          const QString &icon)
{
...
void
StructuralLinkDialog::removeActionInterface (const QString &name)
{
  removeInterface (_form.cbActionInterface, name);
}

void
StructuralLinkDialog::setBase (
    const QMap<QString, QVector<QString> > &conditions,
...
void
StructuralLinkDialog::setMode (const QString &connector,
                               const QString &condition, const QString &action,
                               Mode mode)
{
  _mode = mode;
  ...
  // Setting content...
  if (!connector.isEmpty () && _conditions.contains (connector))
  {
    // Setting 'Connector'...
    _search->setText (connector);
    ...
    // Setting 'Action'...
    if (!action.isEmpty () && _actions.value (connector).contains (action))
    {
  ...
  if (!_aligned)
  {
    ...
    {
      screenGeometry
          = QApplication::desktop ()->screenGeometry (this->parentWidget ());
    }
    else
    {
...
void
StructuralLinkDialog::changeContent (const QString &connector)
{
  // Updating 'Condition'...
  ...
  _form.tbLinkParams->horizontalHeader ()->setSectionResizeMode (
      QHeaderView::Stretch);
  _form.tbConditionParams->horizontalHeader ()->setSectionResizeMode (
      QHeaderView::Stretch);
  _form.tbActionParams->horizontalHeader ()->setSectionResizeMode (
      QHeaderView::Stretch);
...
void
StructuralLinkDialog::switchConnectorParam (int state)
{
  if (!state)
    _form.tbLinkParams->hide ();
  else
...
void
StructuralLinkDialog::switchConditionParam (int state)
{
  if (!state)
    _form.tbConditionParams->hide ();
  else
...
void
StructuralLinkDialog::switchActionParam (int state)
{
  if (!state)
    _form.tbActionParams->hide ();
  else
...
void
StructuralLinkDialog::moveEvent (QMoveEvent *event)
{
...
void
StructuralLinkDialog::resizeEvent (QResizeEvent *event)
{
...
bool
StructuralLinkDialog::event (QEvent *event)
{
...
QMap<QString, QString>
StructuralLinkDialog::getParams (QTableView *widget)
{
...
QString
StructuralLinkDialog::getInterface (const QComboBox *widget)
{
  return widget->currentData ().toString ();
}

void
StructuralLinkDialog::setInterface (QComboBox *widget, const QString &name)
{
  widget->setCurrentText (name);
}

QMap<QString, QString>
StructuralLinkDialog::getInterfaces (const QComboBox *widget)
{
...
void
StructuralLinkDialog::addInterface (QComboBox *widget, const QString &uid,
...
void
StructuralLinkDialog::removeInterface (QComboBox *widget, const QString &name)
{
...
void
StructuralLinkDialog::setParams (QTableView *widget,

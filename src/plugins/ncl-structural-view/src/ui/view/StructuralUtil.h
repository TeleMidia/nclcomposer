...
class StructuralGraphicsEntity;
...
public:
   ...
   */
  static StructuralGraphicsEntity *makeGraphicsEntity(Structural::EntityType type,
                                                StructuralGraphicsEntity *parent = 0,
   ...
   */
  static Structural::EntityType getnstTypeFromMime(const QString &mimeType);
   ...
   */
  static QString iconFromMediaType(Structural::EntityType type);
   ...
   */
  static Structural::EntityType getnstTypeFromExtension(const QString &ext);
   ...
   * \return the media type associated with that extension.
   */
  static Structural::EntityType getnstTypeFromUrlSchema(const QString &urlSchema);
   ...
   */
  static Structural::EntityType getnstTypeFromStr(const QString &strType);
   ...
   */
  static QString getStrFromNstType(Structural::EntityType type);
   ...
   */
  static QString getPrefixIdFromType(Structural::EntityType type);
...
private:
  static std::map <Structural::EntityType, QString>   iconFromTypeMap;
  static std::map <QString, Structural::EntityType>   typeFromExtMap;
  static std::map <QString, Structural::EntityType>   typeFromUrlSchemaMap;
  static std::map <QString, Structural::EntityType>   typeFromStr;
  static std::map <Structural::EntityType, QString>   strFromType;
  static std::map  <Structural::EntityType, QString>  prefixIdFromType;

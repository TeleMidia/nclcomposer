...
#define STR_DEFAULT_BIND_PADDING 4

#define STR_DEFAULT_BIND_TAIL_W 16
#define STR_DEFAULT_BIND_TAIL_H 16

#define STR_DEFAULT_BIND_HEAD_W 16
#define STR_DEFAULT_BIND_HEAD_H 16
